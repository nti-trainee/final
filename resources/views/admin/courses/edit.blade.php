...
@include('admin.layouts.components.forms.edit',["model" => "courses", "data" => $course])
...
@include('admin.layouts.components.forms.file.dropzone', ['inputName' => 'image',
'existingImageUrl' => isset($course) && $course->image ? asset($course->image) : null,
])
<script>
  $(function () {
